...
public class ComputerRepairedFormJdbcRepository implements ComputerRepairedFormRepository {
    private ro.mpp2025.repository.jdbc.JdbcUtils jdbcUtils;

    private final static Logger logger= LogManager.getLogger(ro.mpp2025.repository.jdbc.ComputerRepairRequestJdbcRepository.class);


    public ComputerRepairedFormJdbcRepository(Properties props) {
        jdbcUtils=new ro.mpp2025.repository.jdbc.JdbcUtils(props);
    }
